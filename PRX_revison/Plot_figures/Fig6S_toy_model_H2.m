...
save_dir = fullfile(script_dir, '..', 'Figures_SI', 'Fig6S_toy_model_H2');
if ~exist(save_dir, 'dir')
    mkdir(save_dir);
end

%% Load simulation results (Cov ~ H^2)
prx_root  = fileparts(script_dir);   % PRX_revison
repo_root = fileparts(prx_root);     % Transient_Dynamics_SGD
