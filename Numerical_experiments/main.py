...
def parse_args():
    ...
    parser.add_argument('--save_dir', type=str, default='./test', help='Directory to save checkpoints and results')
...
def main():
    ...
    save_checkpoint_dir = os.path.join(args.save_dir, "checkpoints")
    save_data_dir = os.path.join(args.save_dir, "save_data")
    ...
    checkpoint_path = os.path.join(args.save_dir, 'latest_checkpoint.pt')
    ...
    scipy.io.savemat(os.path.join(save_data_dir, 'save_metrics.mat'), metrics)
