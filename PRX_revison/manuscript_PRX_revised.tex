...
\end{equation}
where $S_{\mathrm{th}}$ is a high-similarity threshold. The definition is robust to the choice of $S_{\mathrm{th}}$ and the other methods (see Supplemental Material for details).
